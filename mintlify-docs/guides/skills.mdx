...
GWD ships with these skills, installed to `~/.agents/skills/`:
...
The `skill_discovery` preference controls how GWD finds skills:
...
/gwd skill-health rust-core    # detailed view
/gwd skill-health --stale 30   # unused for 30+ days
/gwd skill-health --declining  # falling success rates
```
