...
**Placement:**
- `~/.gwd/agent/prompts/` (global)
- `.gwd/prompts/` (project-local)
...
**Placement:**
- `~/.gwd/agent/themes/` (global)
- `.gwd/themes/` (project-local)
