...
- `~/.gwd/agent/extensions/worktree/index.ts`
...
- `~/.gwd/docs/extending-pi/11-custom-commands-user-facing-actions.md`
- `~/.gwd/docs/extending-pi/09-extensionapi-what-you-can-do.md`
- `~/.gwd/agent/extensions/worktree/index.ts`
