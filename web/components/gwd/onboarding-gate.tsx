...
import { navigateToGWDView } from "@/lib/workflow-action-execution"
    ...
    <div className="pointer-events-auto absolute inset-0 z-30 flex flex-col bg-background" data-testid="onboarding-gate">
      ...
      <header className="relative z-10 flex h-12 shrink-0 items-center justify-between px-5 md:px-8">
        ...
        <div className="flex w-24 items-center gap-2">
          <Image src="/logo-white.svg" alt="GWD" width={57} height={16} className="hidden h-4 w-auto dark:block" />
          <Image src="/logo-black.svg" alt="GWD" width={57} height={16} className="h-4 w-auto dark:hidden" />
        </div>
