...
export function ForensicsPanel() {
  ...
  const { loadForensicsDiagnostics } = useGWDWorkspaceActions()
...
export function DoctorPanel() {
  const workspace = useGWDWorkspaceState()
  const { loadDoctorDiagnostics, applyDoctorFixes } = useGWDWorkspaceActions()
...
export function SkillHealthPanel() {
  const workspace = useGWDWorkspaceState()
  const { loadSkillHealthDiagnostics } = useGWDWorkspaceActions()
