...
Long-running `/gwd auto` sessions exhibit high CPU usage due to multiple compounding issues:
...
**File**: `src/resources/extensions/gwd/native-git-bridge.ts`
...
- `src/resources/extensions/gwd/auto.ts` (Fixes 1, 3, 5, 6)
- `src/resources/extensions/gwd/native-git-bridge.ts` (Fix 2)
- `src/resources/extensions/subagent/isolation.ts` (Fix 4)
- `src/resources/extensions/gwd/auto-dashboard.ts` (Fix 7)
- `src/resources/extensions/gwd/tests/` (new test files)
