...
GWD is an AI-powered development agent that turns project ideas into working software. Describe what you want to build, and GWD researches, plans, codes, tests, and commits — with clean git history and full cost tracking.

## How It Works

GWD breaks your project into manageable pieces and works through them systematically:

```
You describe your project
    ↓
GWD creates a milestone with slices (features)
    ↓
...
You can stay hands-on with **step mode** (reviewing each step) or let GWD run autonomously with **auto mode** while you grab coffee.

## Key Features

- **Autonomous execution** — `/gwd auto` runs research, planning, coding, testing, and committing without intervention
...
- **Remote questions** — Get Discord, Slack, or Telegram notifications when GWD needs input
...
|------|---------|----------|
| **Step** | `/gwd` | Staying in the loop, reviewing each step |
| **Auto** | `/gwd auto` | Walking away, overnight builds, batch work |
