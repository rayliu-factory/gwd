// GWD Memory Relations — knowledge-graph edges between memories
//
...
// extractor, or (b) future `/gwd memory link` CLI commands. All writes go
// through the single-writer gate in `gwd-db.ts`.
