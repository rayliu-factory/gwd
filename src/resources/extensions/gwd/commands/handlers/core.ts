...
export function showHelp(ctx: ExtensionCommandContext, args = ""): void {
  const summaryLines = [
    ...
    "  /gwd doctor         Diagnose and repair .gwd/ state",
    "",
  ...
  const fullLines = [
    ...
    "  /gwd pr-branch      Create a clean PR branch filtering .gwd/ commits  [--dry-run|--name]",
    ...
    "",
    "MAINTENANCE",
    "  /gwd doctor         Diagnose and repair .gwd/ state  [audit|fix|heal] [scope]",
    ...
    "  /gwd migrate        Migrate .planning/ (v1) to .gwd/ (v2) format",
