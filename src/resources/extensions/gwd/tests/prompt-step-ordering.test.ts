...
describe('prompt step ordering (#3696)', () => {
  test('complete-milestone prompt orders durable writes before gwd_complete_milestone', async () => {
  ...
  test('complete-slice prompt exposes gwd_requirement_update', async () => {
    const base = makePromptBase();
    try {
