...
import { openDatabase, closeDatabase, insertMilestone, insertSlice, getSlice, getSliceTasks, getTask } from '../gwd-db.ts';
    ...
    tasks: [
      {
        ...
        estimate: '45m',
        files: ['src/resources/extensions/gwd/tools/plan-slice.ts'],
        verify: 'node --test src/resources/extensions/gwd/tests/plan-slice.test.ts',
        inputs: ['src/resources/extensions/gwd/tools/plan-milestone.ts'],
        expectedOutput: ['src/resources/extensions/gwd/tools/plan-slice.ts'],
      ...
      },
      {
        ...
        estimate: '30m',
        files: ['src/resources/extensions/gwd/tools/plan-task.ts'],
        verify: 'node --test src/resources/extensions/gwd/tests/plan-task.test.ts',
        inputs: ['src/resources/extensions/gwd/tools/plan-task.ts'],
        expectedOutput: ['src/resources/extensions/gwd/tests/plan-task.test.ts'],
