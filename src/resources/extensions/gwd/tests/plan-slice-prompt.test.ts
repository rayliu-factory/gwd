...
const BASE_VARS = {
  ...
  slicePath: ".gwd/milestones/M001/slices/S01",
  roadmapPath: ".gwd/milestones/M001/M001-ROADMAP.md",
  researchPath: ".gwd/milestones/M001/slices/S01/S01-RESEARCH.md",
  outputPath: join(fixtureRoot, ".gwd", "milestones", "M001", "slices", "S01", "S01-PLAN.md"),
...
test("plan-slice prompt: commit instruction says do not commit (external state)", () => {
  const result = loadPrompt("plan-slice", { ...BASE_VARS, commitInstruction: "Do not commit planning artifacts — .gwd/ is managed externally." });
...
test("skillActivation default leaves no unresolved placeholder", () => {
  const result = loadPromptWithDefaultSkillActivation("execute-task", {
    ...
    templatesDir: join(fixtureRoot, "templates"),
    taskSummaryPath: join(fixtureRoot, ".gwd", "milestones", "M001", "slices", "S01", "tasks", "T01-SUMMARY.md"),
...
test("research-milestone prompt substitutes skillActivation", () => {
  const result = loadPrompt("research-milestone", {
    ...
    milestonePath: ".gwd/milestones/M001",
    contextPath: ".gwd/milestones/M001/M001-CONTEXT.md",
    outputPath: join(fixtureRoot, ".gwd", "milestones", "M001", "M001-RESEARCH.md"),
...
test("research-slice prompt substitutes skillActivation", () => {
  const result = loadPrompt("research-slice", {
    ...
    roadmapPath: ".gwd/milestones/M001/M001-ROADMAP.md",
    contextPath: ".gwd/milestones/M001/M001-CONTEXT.md",
    milestoneResearchPath: ".gwd/milestones/M001/M001-RESEARCH.md",
    outputPath: join(fixtureRoot, ".gwd", "milestones", "M001", "slices", "S01", "S01-RESEARCH.md"),
    inlinedContext: "Context",
    dependencySummaries: "",
    skillDiscoveryMode: "manual",
    skillDiscoveryInstructions: " Discover skills manually.",
...
test("plan-milestone prompt substitutes skillActivation", () => {
  const result = loadPrompt("plan-milestone", {
    ...
    milestonePath: ".gwd/milestones/M001",
    contextPath: ".gwd/milestones/M001/M001-CONTEXT.md",
    researchPath: ".gwd/milestones/M001/M001-RESEARCH.md",
    researchOutputPath: join(fixtureRoot, ".gwd", "milestones", "M001", "M001-RESEARCH.md"),
    outputPath: join(fixtureRoot, ".gwd", "milestones", "M001", "M001-ROADMAP.md"),
    secretsOutputPath: join(fixtureRoot, ".gwd", "milestones", "M001", "M001-SECRETS.md"),
    inlinedContext: "Context",
