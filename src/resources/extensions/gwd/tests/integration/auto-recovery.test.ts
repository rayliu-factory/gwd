  ...
  try {
    ...
    insertTask({
      ...
      planning: {
        ...
        estimate: "30m",
        files: ["src/resources/extensions/gwd/markdown-renderer.ts"],
        verify: "node --test markdown-renderer.test.ts",
        inputs: ["src/resources/extensions/gwd/gwd-db.ts"],
        expectedOutput: ["src/resources/extensions/gwd/tests/markdown-renderer.test.ts"],
    ...
    insertTask({
      ...
      planning: {
        ...
        estimate: "20m",
        files: ["src/resources/extensions/gwd/auto-recovery.ts"],
        verify: "node --test auto-recovery.test.ts",
        inputs: ["src/resources/extensions/gwd/auto-recovery.ts"],
        expectedOutput: ["src/resources/extensions/gwd/tests/auto-recovery.test.ts"],
...
test("hasImplementationArtifacts returns 'absent' when only .gwd/ files committed (#1703)", (t) => {
...
test("verifyExpectedArtifact complete-milestone fails with only .gwd/ files (#1703)", (t) => {
  const base = makeGitBase();
  t.after(() => cleanup(base));
