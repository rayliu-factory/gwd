// GWD — Extension template import path validation
...
declare module "@gwd/pi-coding-agent" {
...
describe("extension templates use @gwd/* imports", () => {
