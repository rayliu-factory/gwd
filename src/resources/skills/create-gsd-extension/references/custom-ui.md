...
```typescript
import { CustomEditor } from "@gwd/pi-coding-agent";
...
```typescript
import { visibleWidth, truncateToWidth, wrapTextWithAnsi } from "@gwd/pi-tui";
...
**Syntax highlighting:**
```typescript
import { highlightCode, getLanguageFromPath } from "@gwd/pi-coding-agent";
