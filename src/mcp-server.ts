...
/**
 * Minimal tool interface matching GWD's AgentTool shape.
 ...
 *
 * This enables GWD's tools (read, write, edit, bash, grep, glob, ls, etc.)
 ...
 * maps MCP tools/list and tools/call requests to GWD tool definitions and
...
export async function startMcpServer(options: {
  ...
  // tools/list — return every registered GWD tool with its JSON Schema parameters
